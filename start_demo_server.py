...
def prepare_arena(process: subprocess.Popen[str], ready_file: Path, port: int) -> None:
    commands = [
        ...
        "time set noon",
        "weather clear",
        f"fill -6 {ARENA_Y} -6 6 {ARENA_Y} 6 grass_block",
        f"fill -6 {ARENA_Y + 1} -6 6 {ARENA_Y + 12} 6 air",
        f"setblock 2 {ARENA_Y + 1} 0 spruce_log",
        f"setblock 3 {ARENA_Y + 1} 0 spruce_log",
        f"setblock 4 {ARENA_Y + 1} 0 spruce_log",
        f"setblock 5 {ARENA_Y + 1} 0 spruce_log",
        f"setblock 2 {ARENA_Y + 1} 2 cobblestone",
        f"setblock 3 {ARENA_Y + 1} 2 cobblestone",
        f"setblock 4 {ARENA_Y + 1} 2 cobblestone",
        f"setblock 5 {ARENA_Y + 1} 2 cobblestone",
